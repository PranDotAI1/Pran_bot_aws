...
def create_testing_document():
 ...
 if '' in exp or 'SINGLE' in exp or 'NOT' in exp:
 ...
 critical_run = critical_note.add_run(' CRITICAL: These tests verify that duplicate responses have been fixed!')
